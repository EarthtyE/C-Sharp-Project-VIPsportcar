    ...
    public partial class UserControl2 : UserControl
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string insertQuery = "INSERT INTO cartis.car_sport_data(CarID, Status, Brand, CarModel, Color, NumberPlate, Type, History, Pirce, Deposit, Image) VALUES (@carid,@status,@brand,@carmodel,@color,@nbplate,@type,@his,@pirce,@depos,@image)";
                conn.Open();
        ...
        public void FillDGV()
        {
            MySqlCommand command = new MySqlCommand("SELECT * FROM car_sport_data", conn);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            string updataQuery = "UPDATE car_sport_data SET CarID=@carid, Status=@status, Brand=@brand, CarModel=@carmodel, Color=@color, NumberPlate=@nbplate, Type=@type, History=@his, Pirce=@pirce, Deposit=@depos, Image=@image WHERE Carid=@carid";
            conn.Open();
        ...
        {
            string deleteQuery = "DELETE FROM car_sport_data WHERE Carid=@carid";
            conn.Open();

...
namespace WindowsFormsApp6
{
    public partial class Form7 : Form
    {
        ...
        {
            if (textBox2.Text == "" || textBox3.Text == "" || textBox4.Text == "" || textBox5.Text == "" || dateTimePicker1.Text == "" || comboBox1.Text == "" || textBox6.Text == "" || textBox7.Text == "" || textBox8.Text == "" || textBox10.Text == "")
            {
                                            ...
                                            if (r3.IsMatch(textBox5.Text))
                                            {
                                                ...
                                                try
                                                {
                                                    ...
                                                    if (Regex.IsMatch(textBox8.Text, pattern))
                                                    {
                                                        ...
                                                        string insert_data_employee = "INSERT INTO cartis.employee_data(Firstname,Surname,IDcard,Driverslicence,Birthate,Sex,County,Phone,Email,Password) VALUES('" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "','" + textBox5.Text + "','" + dateTimePicker1.Text + "','" + comboBox1.Text + "','" + textBox6.Text + "','" + textBox7.Text + "','" + textBox8.Text + "','" + textBox10.Text + "')";
                                                        executeQuery(insert_data_employee);
                                                        this.Hide();
                                                    }
                                                    else
                                                    {

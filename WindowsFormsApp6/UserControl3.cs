    ...
    public partial class UserControl3 : UserControl
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string insertQuery = "INSERT INTO cartis.car_super_data(CarID, Status, Brand, CarModel, Color, NumberPlate, Type, History, Pirce, Deposit, Image) VALUES (@carid,@status,@brand,@carmodel,@color,@nbplate,@type,@his,@pirce,@depos,@image)";
                conn.Open();
        ...
        public void FillDGV()
        {
            MySqlCommand command = new MySqlCommand("SELECT * FROM car_super_data", conn);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            string updataQuery = "UPDATE car_super_data SET CarID=@carid, Status=@status, Brand=@brand, CarModel=@carmodel, Color=@color, NumberPlate=@nbplate, Type=@type, History=@his, Pirce=@pirce, Deposit=@depos, Image=@image WHERE Carid=@carid";
            conn.Open();
        ...
        {
            string deleteQuery = "DELETE FROM car_super_data WHERE Carid=@carid";
            conn.Open();

...
namespace WindowsFormsApp6
{
    public partial class Form12 : Form
    {
        ...
        private void ShowCarSportInformation()
        {
            ...
            cmd.CommandText = "SELECT * FROM car_sport_data";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                conn.Close();
                /*
                string insert_data_car = "INSERT INTO cartis.car_data(CarID,Status,Brand,CarModel,Color,NumberPlate,Type,History,Pirce,Deposit,Image) VALUES('" + txtCarid.Text + "','" + comboBox1.Text + "','" + txtBrand.Text + "','" + txtModel.Text + "','" + txtColor.Text + "','" + txtPlate.Text + "','" + textBox3.Text + "','" + txtHis.Text + "','" + txtPrice.Text + "','" + txtDepos.Text + "',@img )";

                MySqlCommand command = new MySqlCommand(insert_data_car, conn);
                command.Parameters.Add("@img", MySqlDbType.LongBlob).Value = img; ;
       
                executeQuery(insert_data_car);
                */
